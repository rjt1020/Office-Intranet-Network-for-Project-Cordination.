<%@ Page Language="C#" MasterPageFile="~/projectmembers/PMMasterPage.master" AutoEventWireup="true" CodeFile="composemails.aspx.cs" Inherits="composemails" Title="Untitled Page" %>
                ...
                <table style="width: 700px; height: 173px;">
                    <tr>
                        ...
                        <td style="width: 99px" align="left">
                            <asp:Button ID="Butdiscard" runat="server" Text="Discard" BackColor="Black" 
                                BorderColor="Gainsboro" ForeColor="White" OnClick="Butdiscard_Click" /></td>
                    </tr>
                    <tr>
                        <td style="width: 100px">
                    ...
                    <tr>
                        ...
                        <td colspan="3" align="left">
                            <asp:Button ID="Button2" runat="server" Text="Discard" BackColor="Black" 
                                BorderColor="Gainsboro" ForeColor="White" OnClick="Button2_Click" /></td>
                    </tr>
                </table>
