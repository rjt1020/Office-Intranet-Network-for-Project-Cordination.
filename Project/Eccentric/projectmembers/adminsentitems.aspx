<%@ Page Language="C#" MasterPageFile="~/projectmembers/PMMasterPage.master" AutoEventWireup="true" CodeFile="adminsentitems.aspx.cs" Inherits="adminsentitems" Title="Untitled Page" Theme="admin1"  %>
                ...
                <asp:GridView ID="GridViewmail" runat="server" AutoGenerateColumns="False" BackColor="White"
                    ...
                    <Columns>
                        ...
                        <asp:HyperLinkField DataNavigateUrlFields="subject" DataNavigateUrlFormatString="showinboxmes.aspx?subject={0}"
                            DataTextField="to1" HeaderText="To" NavigateUrl="~/projectmembers/adminsentitems.aspx">
                            <HeaderStyle BackColor="Black" />
                        </asp:HyperLinkField>
                        <asp:HyperLinkField DataNavigateUrlFields="subject" DataNavigateUrlFormatString="showinboxmes.aspx?subject={0}"
                            DataTextField="Subject" HeaderText="Subject" NavigateUrl="~/projectmembers/adminsentitems.aspx">
                            <HeaderStyle BackColor="Black" />
                        </asp:HyperLinkField>
                        <asp:HyperLinkField DataNavigateUrlFields="subject" DataNavigateUrlFormatString="showinboxmes.aspx?subject={0}"
                            DataTextField="date" HeaderText="Date" NavigateUrl="~/projectmembers/adminsentitems.aspx">
                            <HeaderStyle BackColor="Black" />
                        </asp:HyperLinkField>
                    </Columns>
