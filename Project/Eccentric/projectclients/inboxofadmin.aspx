<%@ Page Language="C#" MasterPageFile="~/projectclients/PCMasterPage.master" AutoEventWireup="true" CodeFile="inboxofadmin.aspx.cs" Inherits="inboxofadmin" Title="Untitled Page"  Theme="admin1"%>
                            ...
                            <asp:GridView ID="GridViewmail" runat="server" Height="174px" Width="565px" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" ForeColor="White" GridLines="Vertical">
                                <Columns>
                                    ...
                                    <asp:HyperLinkField  DataNavigateUrlFields="subject" DataNavigateUrlFormatString="showinboxmes.aspx?subject={0}"
                                        DataTextField="from1" HeaderText="From" NavigateUrl="~/projectleader/showinboxmes.aspx">
                                        <HeaderStyle BackColor="Black" />
                                    </asp:HyperLinkField>
                                    <asp:HyperLinkField DataNavigateUrlFields="subject" HeaderText="Subject" DataNavigateUrlFormatString="showinboxmes.aspx?subject={0}" DataTextField="Subject" NavigateUrl="~/projectleader/showinboxmes.aspx" >
                                        <HeaderStyle BackColor="Black" />
                                    </asp:HyperLinkField>  
                                    <asp:HyperLinkField DataNavigateUrlFields="subject" DataNavigateUrlFormatString="showinboxmes.aspx?subject={0}"
                                        DataTextField="date" HeaderText="Date" NavigateUrl="~/projectleader/showinboxmes.aspx">
                                        <HeaderStyle BackColor="Black" />
                                    </asp:HyperLinkField>
                                </Columns>
